...
public:
    ...
    virtual void draw(int& parentHorPos, int& parentVertPos,
                      btScalar deltaTime) = 0;
...
public:
    ...
    GL_TextControl() { m_type = GL_TEXT_CONTROL; }
...
public:
    ...
    GL_ToggleControl(const char* toggleText, btCollisionObject* toggleBody,
...
public:
    GL_SliderControl(const char* sliderText, btCollisionObject* sliderBody,
                     GL_DialogWindow* parentWindow, btScalar lowerLimit,
                     btScalar upperLimit, btTypedConstraint* constaint)
    ...
    btScalar getLowerLimit() { return m_lowerLimit; }
    btScalar getUpperLimit() { return m_upperLimit; }
    btTypedConstraint* getConstraint() { return m_constraint; }
};

/// Very basic OpenGL Graphical Userinterface Window with text, toggle, slider
/// control
class GL_DialogWindow {
    int m_dialogHorPos;
    int m_dialogVertPos;
...
public:
    ...
    int getDialogHorPos() const { return m_dialogHorPos; }
    int getDialogVertPos() const { return m_dialogVertPos; }
    int getDialogWidth() const { return m_dialogWidth; }

    int getDialogHeight() const { return m_dialogHeight; }
    int getScreenWidth() const { return m_screenWidth; }
    int getScreenHeight() const { return m_screenHeight; }

    int getNumControls() const { return m_controls.size(); }

    const GL_DialogControl* getControl(int index) const {
        return m_controls[index];
    }
    GL_DialogControl* getControl(int index) { return m_controls[index]; }
};
