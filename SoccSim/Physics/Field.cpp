	...
	Entity(env)
{
	...
	*/
	...
	NxBoxShapeDesc rear = box(.001, Constants::Field::GoalWidth, 
			-Constants::Field::Length/2.0 - Constants::Field::GoalDepth, 0);
	
	NxBoxShapeDesc side1 = box(Constants::Field::GoalDepth, .001, 
	...
	NxBoxShapeDesc wall1 = box(Constants::Floor::Length, .001, 0, Constants::Floor::Width/2.0);
	NxBoxShapeDesc wall2 = wall1;
	wall2.localPose.t.y *= -1.0f;
	
	NxBoxShapeDesc wall3 = box(.001, Constants::Floor::Width, Constants::Floor::Length/2.0, 0);
