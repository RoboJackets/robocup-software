...
struct FieldDimensions {
    ...
    FieldDimensions(float fl, float fw, float fb, float flw, float gw, float gd,
                    float gh, float psd, float pld, float cr, float cd,
                    float gf, float ffl, float ffw)
        : _Length(fl),
          _Width(fw),
          _Border(fb),
          _LineWidth(flw),
    ...
    static FieldDimensions fromMsg(const FieldDimensionsMsg& msg) {
        return FieldDimensions{msg.length,
                               msg.width,
                               msg.border,
                               msg.line_width,
                               msg.goal_width,
