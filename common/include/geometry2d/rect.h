...
#include <rj_robocup/msg/rect.hpp>

namespace geometry2d {
using RectMsg = rj_robocup::msg::Rect;
...
class Rect : public Shape {
 ...
 public:
  ...
  Rect operator+(Point offset) { return Rect(pt[0] + offset, pt[1] + offset); }
  ...
  [[nodiscard]] inline RectMsg toMsg() const {
    RectMsg msg{};
