...
// If a transfer is in progress, the device will be deselected after the transfer is finished.
// Another transfer to the same device can be started without calling spi_select() again.
