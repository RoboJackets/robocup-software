...
* @brief This header file defines the registers, strobe, and states of the CC1101 Sub-1GHz Transceiver
*/
...
#define CCXXX1_SRX          0x34        // Enable RX. Perform calibration first if coming from IDLE and
#define CCXXX1_STX          0x35        // In IDLE state: Enable TX. Perform calibration first if
#define CCXXX1_SIDLE        0x36        // Exit RX / TX, turn off frequency synthesizer and exit
...
// READ ONLY REGISTERS
#define CCXXX1_SNOP             0x3D        // No operation. May be used to pad strobe commands to two bytes for simpler software.
