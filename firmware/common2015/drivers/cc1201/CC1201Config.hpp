...
public:
    ...
    /**
     * Resets the provided instance of CC1201Config to the defaults established
     * by the included header file. The header file is generated by RF studio
     * and the desired configuration should be included in CC1201Radio.hpp by
     * following the the directions there.
     *
    ...
    /**
     * Loads the provided instance of CC1201Config into a CC1201Device using
     * that device's write functions.
     *
    ...
    /**
     * Verifies the configuration readback of the given CC1201 device against
     * the given CC1201Config specification.
     *
     * @param CC1201Config* the instance holding the preferred CC1201
     *     configuration
     * @param CC1201* the device against which the preferred CC1201Config will
     *     be checked
     * @return if the verfication is error free (false means you should check
     *     the error queue)
     */
    ...
    uint8_t
        symbolRate2;  // Symbol Rate Configuration Exponent and Mantissa [1..
    ...
    uint8_t
        settlingCfg;  // Frequency Synthesizer Calibration and Settling Con..
    ...
    uint8_t
        fsRegDivCml;  // Frequency Synthesizer Divider Regulator Configurat..
    ...
    uint8_t
        paIfampTest;     // Power Amplifier Intermediate Frequency Amplifier T..
