...
if len(sys.argv) != 3:
    print("Usage: %s path/to/smartrf.xml outputfile.h" % sys.argv[0], file=sys.stderr)
    exit(1)
...
with open(outfile, 'w') as out:
    ...
    out.write("// It was automatically generated from a smartrf xml file by the smartrf exporter script\n")
