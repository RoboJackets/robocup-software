...
// #define SMARTRF_SETTING_IOCFG0             0x07	// Asserted when PKT_CRC_OK
// is set. De-asserted at first byte read from the RX FIFO
#define SMARTRF_SETTING_IOCFG0 \
    0x0B  // Asserted when preamble quality threshold is reached
// #define SMARTRF_SETTING_IOCFG0             0x0C	// Asserted when preamble is
// deemed to be valid
// #define SMARTRF_SETTING_IOCFG0             0x0D	// RSSI calculation is valid
// #define SMARTRF_SETTING_IOCFG0             0x11	// High if RSSI level is
// above threshold
...
#define SMARTRF_SETTING_SYNC_CFG1 \
    0xA4  // 32 bit sync word length; Threshold value of `10` (or 0x04 here)
          // from TI's SmartRF Studio GUI
#define SMARTRF_SETTING_SYNC_CFG0 \
    0x03  // PQT gating disabled; External sync detect disabled; Strict sync
          // word check disabled
...
#define SMARTRF_SETTING_PREAMBLE_CFG1 \
    0x18  // Minimum of 4 preamble bytes to be transmitted; Preamble word = 0xAA
#define SMARTRF_SETTING_PREAMBLE_CFG0 0x8A  // FROM RFSTUDIO
#define SMARTRF_SETTING_IQIC 0x00           // FROM RFSTUDIO
#define SMARTRF_SETTING_CHAN_BW 0x01        // FROM RFSTUDIO
...
#define SMARTRF_SETTING_RFEND_CFG0 \
    0x00  // wake-up pulses disabled (default); TXOFF mode -> RX (NOT DEFAULT);
...
#define SMARTRF_SETTING_FREQOFF_CFG \
    0x2B  // FROM RFSTUDIO - THIS IS A PRETTY DAMN IMPORTANT CONFIGURATION VALUE
          // FOR 4-GFSK!
