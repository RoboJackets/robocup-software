...
#define SMARTRF_SETTING_SYNC_CFG1          0xA4 // 32 bit sync word length; Threshold value of `10` (or 0x04 here) from TI's SmartRF Studio GUI
#define SMARTRF_SETTING_SYNC_CFG0          0x03 // PQT gating disabled; External sync detect disabled; Strict sync word check disabled
