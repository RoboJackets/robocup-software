...
static void smart_init(int argc, const char *argv[])
{
	for (int i = 0; i < 4; ++i)
	{
		last_out[i] = 0;
...
static void smart_received()
{
	//	TODO: adjust position based on camera readings from packet
	//	TODO: update target path, etc
}
...
static Orientation last_vision_orientation;
...
{
	//	TODO: integrate!
	//		TODO: calculate velocities based on accelerations
	//		TODO: calculate positions based on velocities
