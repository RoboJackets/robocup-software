...
/** @defgroup EXAMPLES_PERIPH_8XX_CLKOUT LPC8xx Clock output example
...
int main(void)
{
	...
	Chip_IOCON_PinSetMode(LPC_IOCON, PIO1, PIN_MODE_PULLUP);

	/* Connect the SWM_CLKOUT_O signal to port pin P0.1 */
	Chip_SWM_MovablePinAssign(SWM_CLKOUT_O, PIO1);
