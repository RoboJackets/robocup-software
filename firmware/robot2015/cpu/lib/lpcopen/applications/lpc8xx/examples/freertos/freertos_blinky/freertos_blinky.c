...
/** @defgroup EXAMPLES_FREERTOS_8XX_BLINKY LPC8xx FreeRTOS blinky example
 * @ingroup EXAMPLES_FREERTOS_8XX
 * <b>Example description</b><br>
 * Welcome to the FreeRTOS basic blinky example. This example starts up
 * FreeRTOS and creates 3 tasks that blink LEDs at different rates.<br>
 *
