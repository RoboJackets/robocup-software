/*
 * @brief Mouse HID device class ROM based application's specific functions supporting core layer
 *
 * @note
...
/** @defgroup Mouse_Device_ROM_Based ROM stack support
 * @ingroup USB_Mouse_Device_18xx43xx USB_Mouse_Device_11Uxx
 * @{
 */

/** @defgroup Mouse_Device_ROM_Based_Core ROM based core
 * @{
 */
...
/** @defgroup Mouse_HID_Device_ROM_Based_HID_Device_Class ROM based class HID
 * @{
 */
