...
/** @defgroup Keyboard_Device_ROM_Based ROM stack support
 * @ingroup USB_Keyboard_Device_18xx43xx USB_Keyboard_Device_11Uxx
 * @{
 */

/** @defgroup Keyboard_Device_ROM_Based_Core ROM based core
 * @{
 */
...
/** @defgroup Keyboard_HID_Device_ROM_Based_HID_Device_Class ROM based class HID
 * @{
 */
