...
/** @defgroup EXAMPLES_PERIPH_13XX_WWDT LPC13xx Watchdog timer example
 ...
 * The 1st way (both WWDT and WDT) can be enabled by commenting out the
...
int main(void)
{
	...
	/* LPC1343 devices select the watchdog
	   clock source from the SYSCLK block, while LPC1347 devices select
	   the clock as part of the watchdog block. */
