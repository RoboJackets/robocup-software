...
/** @defgroup EXAMPLES_PERIPH_13XX_CLKOUT LPC13xx Clock output example
 ...
 * connect an oscilloscope to the CLKOUT pin on your board.<br>
 *
 * <b>Special connection requirements</b><br>
 * Observe the clock out on pin PIO0_1 (J6-38) by using oscilloscope.<br>
 *
