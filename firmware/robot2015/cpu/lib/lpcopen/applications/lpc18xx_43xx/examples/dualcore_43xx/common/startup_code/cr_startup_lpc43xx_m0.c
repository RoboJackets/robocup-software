...
void(*const g_pfnVectors[]) (void) = {
	...
	0,								// Reserved
    (void (*)(void))M0_Image_Magic, // 8 Reserved
    (void (*)(void))&__M0Signature, // 9 Reserved
	0,								// Reserved
...
extern unsigned int __bss_section_end;
...
ResetISR(void) {
	...
	while (SectionTableAddr < &__bss_section_end) { /* Not __bss_section_table_end */
		ExeAddr = *SectionTableAddr++;
		SectionLen = *SectionTableAddr++;
