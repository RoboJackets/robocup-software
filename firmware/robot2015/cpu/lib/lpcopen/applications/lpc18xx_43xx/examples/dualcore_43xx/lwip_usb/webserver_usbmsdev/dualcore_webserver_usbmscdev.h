/*
 * @brief	LWIP HTTP server & LPCUSBlib Mass Storage Device dual core example
 *
 * @note
...
/** @defgroup EXAMPLE_DUALCORE_LWIP_MassStorage LWIP HTTP Server & LPCUSBlib USB Mass Storage Device dual core example.
 ...
 * implemented using LCPUSBlib library.
