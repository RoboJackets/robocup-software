...
/** @defgroup EXAMPLES_PERIPH_18XX43XX_I2C LPC18xx/43xx I2C example
 ...
 * below for using the example without uart, others can skip the following paragraph.<br>
 *
 ...
 * and it will act as the master and will send data to the slave board).<br><br>
 *
 ...
 *
 * To turn on LED1 and LED2 using IOX Slave, follow the steps given below <br>
 ...
 *  - Hitex LPC1850EVA-A4-2 and LPC4350EVA-A4-2 boards (using UART0)<br>
 *    - I2C1_SDA (X20 pin 5) connected to I2C0_SDA (SV19 pin 4) <br>
 *    - I2C1_SCL (X20 pin 3) connected to I2C0_SCL (SV19 pin 6) <br>
 *    - Remove the jumpers from SV19 if required and place back once example is done <br>
 *  - Keil MCB1857 and MCB4357 boards (using UART3)<br>
 *    - PE.13 : I2C1_SDA be connected to J8(SDA) (RFID Board connector)<br>
 *    - PE.15 : I2C1_SCL be connected to J9(SCL) (RFID Board connector)<br>
 ...
 *    - (J10 PIN13) I2C1_SDA must be connected between boards [P2.3]<br>
 *    - (J10 PIN14) I2C1_SCL must be connected between boards [P2.4]<br>
 *    - (J10 PIN27) GND must be connected between boards<br>
 *
