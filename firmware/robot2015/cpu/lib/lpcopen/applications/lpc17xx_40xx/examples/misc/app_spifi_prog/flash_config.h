...
/** @ingroup EXAMPLES_MISC_17XX40XX_SPIFI_PROGRAMMER
 * @{
 */
...
#ifdef BOARD_EA_DEVKIT_17884088
	#define SPIFLASH_SECTOR_SIZE        (64 * 1024)		/* 512Kb/sector */
	#define SPIFLASH_NUM_OF_SECTORS     (64)
	#define SPIFLASH_DEVICE_SIZE        (SPIFLASH_NUM_OF_SECTORS * SPIFLASH_SECTOR_SIZE)
#else
...
#define spifi_rom_init()                 define_spifi_romPtr(SPIFI_ROM_PTR, spifi)
#endif
