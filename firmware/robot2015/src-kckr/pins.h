...
// #define MOSI_PIN        (PA6)   // pin 7, not actually used in code; already defined in iotn84a.h
...
#define DB_CHG_PIN      (PB2)   // pressed = enable_charging; unpressed = disable_charging
