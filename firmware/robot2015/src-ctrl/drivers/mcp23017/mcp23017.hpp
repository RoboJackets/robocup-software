...
public:
     ...
     */
    static void config(unsigned short dir_config, unsigned short pullup_config,
...
private:
    ...
    static void set_config(PinName sda, PinName scl,
                           int i2cAddress = RJ_IO_EXPANDER_I2C_ADDRESS);
