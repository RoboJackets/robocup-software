 ...
 * stores
 *  a unique 48-bit serial number, an 8-bit family code (0x01), and an 8-bit CRC
 * value
 ...
 * DS2411_ID block.
 *  If debug is set to true, the received data is formatted and printed to
 * stdout.
 *  If the computed CRC using the family and serial bytes does not match the
 * received crc, CRC_FAIL is returned.
