...
enum IOExpanderPin {
    ...
    RJ_ERR_LED_M1 = RJ_IOEXP_B1,
    RJ_ERR_LED_M2 = RJ_IOEXP_B0,
    RJ_ERR_LED_M3 = RJ_IOEXP_B5,
    RJ_ERR_LED_M4 = RJ_IOEXP_B7,
    RJ_ERR_LED_MPU = RJ_IOEXP_B6,
    RJ_ERR_LED_BSENSE = RJ_IOEXP_B4,
    RJ_ERR_LED_DRIB = RJ_IOEXP_B3,
    RJ_ERR_LED_RADIO = RJ_IOEXP_B2,
};
