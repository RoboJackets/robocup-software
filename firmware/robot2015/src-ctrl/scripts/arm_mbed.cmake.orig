...
# Use filenames relative to the src-cpu directory for logging output paths
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -D__FILE_NAME__='\"$(subst ${PROJECT_SOURCE_DIR}/,,$(basename $(abspath $<)))\"'")
