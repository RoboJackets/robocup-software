...
int main() {
  ...
  ballSense.start(25); // TODO(justin): choose smarter update frequency
  ...
  while (true) {
    ...
    Thread::wait(RJ_WATCHDOG_TIMER_VALUE * 25);
