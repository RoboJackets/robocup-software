 ...
 *  		This file supports assembler and C development for DW1000
 *enabled devices
 *
 * @attention
 *
...
/*offset 0 */
#define SYS_CFG_FFE                                                            \
  0x00000001UL /* Frame Filtering Enable. This bit enables the frame filtering \
                  functionality */
...
#define TX_FCTRL_PE_SHFT                                                       \
  (20) /* shift to access Preamble length Extension to allow specification of  \
          non-standard values */
...
#define TX_FCTRL_TXBOFFS_MASK                                                  \
  0xFF000000UL /* bit mask to access Transmit buffer index offset 10-bit field \
                  */
/*offset 32 */
...
#define SYS_CTRL_TXDLYS                                                        \
  0x00000004UL /* Transmitter Delayed Sending (initiates sending when SYS_TIME \
                  == TXD_TIME */
#define SYS_CTRL_CANSFCS                                                       \
  0x00000008UL /* Cancel Suppression of auto-FCS transmission (on the current  \
                  frame) */
...
#define SYS_CTRL_RXDLYE                                                        \
  0x00000200UL /* Receiver Delayed Enable (Enables Receiver when SY_TIME[0x??] \
                  == RXD_TIME[0x??] CHECK comment*/
/*offset 16 */
/*offset 24 */
#define SYS_CTRL_HSRBTOGGLE                                                    \
  0x01000000UL /* Host side receiver buffer pointer toggle - toggles 0/1 host  \
                  side data set pointer */
...
#define SYS_STATUS_MASK_32                                                     \
  0xFFF7FFFFUL /* System event Status Register access mask (all unused fields  \
                  should always be writen as zero) */
/*offset 0 */
...
#define SYS_STATUS_TXERR                                                       \
  (0x0408) /* These bits are the 16 high bits of status register TXPUTE and    \
              HPDWARN flags */
...
#define RX_FINFO_MASK_32                                                       \
  0xFFFFFBFFUL /* System event Status Register access mask (all unused fields  \
                  should always be writen as zero) */
...
#define RX_FINFO_RXPSR_MASK                                                    \
  0x000C0000UL /* RX Preamble Repetition. 00 = 16 symbols, 01 = 64 symbols, 10 \
...
#define RX_FINFO_RXBR_MASK                                                     \
  0x00006000UL /* Receive Bit Rate report. This field reports the received bit \
                  rate */
...
#define RX_TTCKO_MASK_32                                                       \
  0xFF07FFFFUL /* Receiver Time Tracking Offset access mask (all unused fields \
                  should always be writen as zero) */
/*offset 0 */
...
#define TX_POWER_TXPOWPHR_MASK                                                 \
  0x0000FF00UL /* This power setting is applied during the transmission of the \
                  PHY header (PHR) portion of the frame. */
#define TX_POWER_TXPOWSD_MASK                                                  \
  0x00FF0000UL /* This power setting is applied during the transmission of the \
...
#define CHAN_CTRL_DWSFD                                                        \
  0x00020000UL /* Bit 17 This bit enables a non-standard DecaWave proprietary  \
                  SFD sequence. */
#define CHAN_CTRL_DWSFD_SHIFT (17)
#define CHAN_CTRL_TNSSFD                                                       \
  0x00100000UL /* Bit 20 Non-standard SFD in the transmitter */
#define CHAN_CTRL_TNSSFD_SHIFT (20)
#define CHAN_CTRL_RNSSFD                                                       \
  0x00200000UL /* Bit 21 Non-standard SFD in the receiver */
...
#define EC_CTRL_WAIT_MASK                                                      \
  0x000007F8UL /* Wait counter used for external transmit synchronisation and  \
...
#define EC_GOLP_MASK                                                           \
  0x0000003FUL /* sub-register 0x08 is the External clock offset to first path \
                  1 GHz counter, EC_GOLP */
...
#define GPIO_PIN5_EXTTXE_8                                                     \
  0x01 /* The pin operates as the EXTTXE output. byte */
#define GPIO_PIN6_EXTRXE_8                                                     \
  0x04 /* The pin operates as the EXTRXE output. byte */
...
#define GxP0                                                                   \
  0x00000001UL /* GPIO0 Only changed if the GxM0 mask bit has a value of 1 for \
                  the write operation*/
...
#define GIMOD0                                                                 \
  GIRQx0 /* GPIO IRQ Mode selection for GPIO0 input. Value 0 = Level sensitive \
...
#define GIBES0                                                                 \
  GIRQx0 /* GPIO IRQ “Both Edge” selection for GPIO0 input. Value 0 =          \
            GPIO_IMODE register selects the edge. Value 1 = Both edges trigger \
            the interrupt. */
...
#define GIDBE0                                                                 \
  GIRQx0 /* GPIO IRQ de-bounce enable for GPIO0. Value 1 = de-bounce enabled.  \
...
//#define TC_SARL_OFFSET            0x03            /* Transmitter Calibration –
//Latest SAR readings. RO */
...
/* offset from TX_CAL_ID in bytes */
//#define TC_SARW_OFFSET            0x06            /* Transmitter Calibration –
//SAR readings at last Wake-Up */
...
#define FS_XTALT_MASK                                                          \
  0x1F /* Crystal Trim. Crystals may be trimmed using this register setting to \
          tune out errors, see 8.1 – IC Calibration – Crystal Oscillator Trim. \
          */
...
#define AON_CFG1_LPOSC_CAL                                                     \
  0x0004 /* This bit enables the calibration function that measures the period \
            of the IC’s internal low powered oscillator */
...
#define OTP_CTRL_OTPPROG                                                       \
  0x0040 /* Setting this bit will cause the contents of OTP_WDAT to be written \
            to OTP_ADDR. */
/* offset from OTP_IF_ID in bytes */
...
#define LDE_PPAMPL_OFFSET                                                      \
  0x1002 /* reporting the magnitude of the peak signal seen in the accumulator \
            data memory */
...
#define EVC_FFR_OFFSET                                                         \
  0x0C /* The EVC_FFR field is a 12-bit counter of the frames rejected by the  \
          receive frame filtering function. */
...
#define EVC_PTO_OFFSET                                                         \
  0x12 /* The EVC_PTO field is a 12-bit counter of Preamble detection Timeout  \
          events */
...
#define EVC_FWTO_OFFSET                                                        \
  0x14 /* The EVC_FWTO field is a 12-bit counter of receive frame wait timeout \
          events */
#define EVC_FWTO_LEN (2)
#define EVC_FWTO_MASK 0x0FFF
/* offset from DIG_DIAG_ID in bytes */
#define EVC_TXFS_OFFSET                                                        \
  0x16 /* The EVC_TXFS field is a 12-bit counter of transmit frames sent. This \
          is incremented every time a frame is sent */
...
#define EVC_RES1_OFFSET                                                        \
  0x1C /* Please take care not to write to this register as doing so may cause \
...
#define PMSC_CTRL0_RXCLKS_AUTO                                                 \
  0x00000000UL /* The RX clock will be disabled until it is required for an RX \
                  operation */
...
#define PMSC_CTRL0_TXCLKS_AUTO                                                 \
  0x00000000UL /* The TX clock will be disabled until it is required for a TX  \
                  operation */
...
/* offset from PMSC_ID in bytes */
#define PMSC_TXFINESEQ_OFFSET                                                  \
  0x26 /* Writing PMSC_TXFINESEQ_DIS_MASK disables fine grain sequencing in    \
          the transmitter*/
#define PMSC_TXFINESEQ_DIS_MASK (0x0)
#define PMSC_TXFINESEQ_EN_MASK                                                 \
  (0B74) /* Writing PMSC_TXFINESEQ_EN_MASK enables fine grain sequencing in    \
            the transmitter*/
/* offset from PMSC_ID in bytes */
...
#define PMSC_LEDC_BLINK_TIM_MASK                                               \
  0x000000FFUL /* This field determines how long the LEDs remain lit after an  \
                  event that causes them to be set on. default 0x20 give 0x20  \
                  * 14mS = 400mS */
