        ...
        (function() {
            ...
            n.exports.ThemeNav = {
                ...
                init: function(n) {
                    ...
                    n('.wy-menu-vertical ul').not('.simple').siblings('a').each((function() {
                        var t = n(this);
                        expand =
                            n('<button class="toctree-expand" title="Open/close menu"></button>'),
                ...
                reset: function() {
                    ...
                    try {
                        ...
                        if (0 === t.length) {
                            var i =
                                $('.document [id="' + n.substring(1) + '"]').closest('div.section');
            ...
            function() {
                for (var n = 0, e = ['ms', 'moz', 'webkit', 'o'], t = 0;
                    ...
                    window.cancelAnimationFrame = window[e[t] + 'CancelAnimationFrame'] ||
