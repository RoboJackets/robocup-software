...
!function(e, t) {
    ...
    S.event = {
        ...
        remove: function(e, t, n, r, i) {
            ...
            if (v && (u = v.events)) {
                ...
                while (l--)
                    if (d = g = (s = be.exec(t[l]) || [])[1], h = (s[2] || '').split('.').sort(),
                        d) {
                        f = S.event.special[d] || {},
        ...
        e && e.type ?
            (this.originalEvent = e, this.type = e.type,
             this.isDefaultPrevented =
                 e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? we :
                                                                                               Te,
    ...
    nt = E.createElement('select').appendChild(E.createElement('option')), tt.type = 'checkbox',
    y.checkOn = '' !== tt.value, y.optSelected = nt.selected,
