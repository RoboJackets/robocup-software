!function(n, r) {
    'object' == typeof exports&& 'undefined' != typeof module ?
        ...
        define('underscore', r) :
        (n = 'undefined' != typeof globalThis ? globalThis : n || self, function() {
            var t = n._, e = n._ = r();
      ...
      //     (c) 2009-2021 Jeremy Ashkenas, Julian Gonggrijp, and DocumentCloud and Investigative
      //     Reporters & Editors Underscore may be freely distributed under the MIT license.
      var n = '1.13.1',
          r = 'object' == typeof self && self.self === self && self ||
          'object' == typeof global && global.global === global && global ||
          Function('return this')() || {},
          t = Array.prototype, e = Object.prototype,
          u = 'undefined' != typeof Symbol ? Symbol.prototype : null, o = t.push, i = t.slice,
          a = e.toString, f = e.hasOwnProperty, c = 'undefined' != typeof ArrayBuffer,
          l = 'undefined' != typeof DataView, s = Array.isArray, p = Object.keys, v = Object.create,
          h = c && ArrayBuffer.isView, y = isNaN, d = isFinite,
      ...
      var S = x('String'), O = x('Number'), M = x('Date'), E = x('RegExp'), B = x('Error'),
          N = x('Symbol'), I = x('ArrayBuffer'), T = x('Function'),
          ...
          return ('function' === o || 'object' === o || 'object' == typeof r) &&
              function n(r, t, e, o) {
                  ...
                  if (!f) {
                      ...
                      if (c !== l && !(D(c) && c instanceof c && D(l) && l instanceof l) &&
      ...
      var cn = 'forEach', ln = 'has', sn = ['clear', 'delete'], pn = ['get', ln, 'set'],
          vn = sn.concat(cn, pn), hn = sn.concat(pn), yn = ['add'].concat(sn, cn, ln),
          dn = V ? fn(vn) : x('Map'), gn = V ? fn(hn) : x('WeakMap'), bn = V ? fn(yn) : x('Set'),
          mn = x('WeakSet');
      function jn(n) {
      ...
      function Jr(n, r, t, e) {
          ...
          for (var u = [], o = [], i = 0, a = Y(n); i < a; i++) {
              ...
              r && !t ? (i && o === c || u.push(f), o = c) :
                        t ? Er(o, c) || (o.push(c), u.push(f)) : Er(u, f) || u.push(f)
          }
          return u
      }
      var Gr = j((function(n) {
      ...
      var Zr = Yr({
          ...
          throttle: function(n, r, t) {
              ...
              var f = function() {
                  ...
                  return u = this, o = arguments,
                         l <= 0 || l > r ? (e && (clearTimeout(e), e = null), a = c,
          ...
          last: function(n, r, t) {
              return null == n || n.length < 1 ?
                  null == r || t ? void 0 : [] :
                  null == r || t ? n[n.length - 1] : $r(n, Math.max(0, n.length - r))
          },
          rest: $r,
          tail: $r,
          drop: $r,
          ...
          range: function(n, r, t) {
              ...
              for (var e = Math.max(Math.ceil((r - n) / t), 0), u = Array(e), o = 0; o < e;
                   o++, n += t)
                  u[o] = n;
              return u
          },
