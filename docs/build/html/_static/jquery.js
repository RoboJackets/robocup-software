...
!function(e, t) {
    ...
    var d = function(n) {
        var e, d, b, o, i, h, f, g, w, u, l, T, C, a, E, v, s, c, y,
            S = 'sizzle' + 1 * new Date, p = n.document, k = 0, r = 0, m = ue(), x = ue(), A = ue(),
            N = ue(),
            D =
                function(e, t) {
                return e === t && (l = !0), 0
        ...
        return me.prototype = b.filters = b.pseudos, b.setFilters = new me,
               ...
               d.sortStable = S.split('').sort(D).join('') === S, d.detectDuplicates = !!l, T(),
                ...
                (n = r.style.display,
                 t ? ('none' === n &&
                      ...
                      '' === r.style.display && ae(r) &&
                          (l[c] =
                               (u = a = o = void 0, a = (i = r).ownerDocument, s = i.nodeName,
                                (u = ue[s]) ||
            ...
            handler: function(e) {
                ...
                if (1 & e.isTrigger && this[i]) {
                    if (r.length)
                        ...
                        r = s.call(arguments), Y.set(this, i, r), t = o(this, i), this[i](),
                    ...
                    r.length &&
                        (Y.set(this, i, {
                            value:
                                S.event.trigger(S.extend(r[0], S.Event.prototype), r.slice(1), this)
                        }),
    ...
    S.event = {
        ...
        add: function(t, e, n, r, i) {
            ...
            if (V(t)) {
                ...
                while (l--)
                    d = g = (s = Te.exec(e[l]) || [])[1], h = (s[2] || '').split('.').sort(),
                    d &&
                        (f = S.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d,
                         f = S.event.special[d] || {},
                         c = S.extend(
                             {
                                 type: d,
        ...
        addProp: function(t, e) {
            Object.defineProperty(S.Event.prototype, t, {
                ...
                set: function(e) {
                    Object.defineProperty(
                        this, t, {enumerable: !0, configurable: !0, writable: !0, value: e})
                }
            })
        },
        fix: function(e) {
        ...
        special: {
            ...
            click: {
                ...
                _default: function(e) {
                    var t = e.target;
                    return pe.test(t.type) && t.click && A(t, 'input') && Y.get(t, 'click') ||
                        A(t, 'a')
                }
            },
            beforeunload: {
            ...
            (l.style.backgroundClip = 'content-box', l.cloneNode(!0).style.backgroundClip = '',
             y.clearCloneStyle = 'content-box' === l.style.backgroundClip, S.extend(y, {
                 ...
                 reliableTrDimensions: function() {
                     var e, t, n, r;
                     return null == a &&
                                (e = E.createElement('table'), t = E.createElement('tr'),
                    ...
                    set: function(e, t, n) {
                        ...
                        return a && o &&
                                   (s -= Math.ceil(
                                        ...
                                        parseFloat(i[u]) - Ke(e, u, 'border', !1, i) - .5)),
    ...
    function ct(e, t, n) {
        for (var r, i = (ft.tweeners[t] || []).concat(ft.tweeners['*']), o = 0, a = i.length; o < a;
             o++)
            ...
            if ((u = !S.isEmptyObject(t)) || !S.isEmptyObject(d))
                for (r in f && 1 === e.nodeType &&
                         ...
                         'none' === (c = S.css(e, 'display')) &&
                              (l ? c = l :
                                   (le([e], !0), l = e.style.display || l, c = S.css(e, 'display'),
                                                 le([e]))),
    ...
    it = E.createElement('select').appendChild(E.createElement('option')), rt.type = 'checkbox',
    y.checkOn = '' !== rt.value, y.optSelected = it.selected,
    ...
    S.extend(S.event, {
        trigger: function(e, t, n, r) {
            ...
            if (o = f = a = n = n || E,
                3 !== n.nodeType && 8 !== n.nodeType && !bt.test(d + S.event.triggered) &&
                    (-1 < d.indexOf('.') && (d = (h = d.split('.')).shift(), h.sort()),
                     ...
                     t = null == t ? [e] : S.makeArray(t, [e]), c = S.event.special[d] || {},
                    ...
                    S.fn[o] = function(e, t) {
                        ...
                        return $(this, function(e, t, n) {
                            ...
                            return x(e) ?
                                ...
                                (r = e.documentElement,
                                 Math.max(
                                     e.body['scroll' + a], r['scroll' + a], e.body['offset' + a],
