...
var Search = {
    ...
    query: function(query) {
        ...
        for (i = 0; i < objectterms.length; i++) {
            var others =
                [].concat(objectterms.slice(0, i), objectterms.slice(i + 1, objectterms.length));
        ...
        function displayNextItem() {
            ...
            if (results.length) {
                ...
                listItem.append(
                    $('<a/>').attr('href', linkUrl + highlightstring + item[2]).html(item[1]));
                if (item[3]) {
    ...
    performTermsSearch: function(searchterms, excluded, terms, titleterms) {
        ...
        for (file in fileMap) {
            ...
            if (valid) {
                ...
                // for better ranking, we should calculate ranking by using words statistics like
                // basic tf-idf...
