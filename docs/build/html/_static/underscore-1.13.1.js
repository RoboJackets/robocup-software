...
function createSizePropertyCheck(getSizeProperty) {
    return function(collection) {
        ...
        return typeof sizeProperty == 'number' && sizeProperty >= 0 &&
...
function toBufferView(bufferSource) {
    return new Uint8Array(
        bufferSource.buffer || bufferSource, bufferSource.byteOffset || 0,
...
function deepEq(a, b, aStack, bStack) {
    ...
    if (!areArrays) {
        ...
        if (aCtor !== bCtor &&
            !(isFunction$1(aCtor) && aCtor instanceof aCtor && isFunction$1(bCtor) &&
    ...
    if (areArrays) {
        ...
        length = _keys.length;
        // Ensure that both objects contain the same number of properties before comparing deep
        // equality.
...
var forEachName = 'forEach', hasName = 'has', commonInit = ['clear', 'delete'],
