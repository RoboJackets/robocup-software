...
!function(a, b) {
    ...
    function g(a, c, d) {
        ...
        return e = d.cache[a] ?
                   d.cache[a].cloneNode() :
                   u.test(a) ? (d.cache[a] = d.createElem(a)).cloneNode() : d.createElem(a),
    ...
    function i(a, b) {
        b.cache ||
            (b.cache = {}, b.createElem = a.createElement, b.createFrag = a.createDocumentFragment,
             b.frag = b.createFrag()),
            a.createElement =
                function(c) {
    ...
    function k(a) {
        for (var b, c = a.getElementsByTagName('*'), e = c.length,
                    f = RegExp('^(?:' + d().join('|') + ')$', 'i'), g = [];
             e--;)
    ...
    function l(a) {
        for (var b, c = a.attributes, d = c.length,
    ...
    function m(a) {
        for (var b, c = a.split('{'), e = c.length,
                    f = RegExp('(^|[\\s,>+~])(' + d().join('|') + ')(?=[[\\s,>+~#.:]|$)', 'gi'),
                    g = '$1' + A + '\\:$2';
             e--;)
            b = c[e] = c[e].split('}'), b[b.length - 1] = b[b.length - 1].replace(f, g),
            c[e] = b.join('}');
        return c.join('{')
    }
    function n(a) {
    ...
    function o(a) {
        ...
        return !B || a.printShived ?
            a :
            ('undefined' == typeof h[A] && h.add(A), i.attachEvent('onbeforeprint', function() {
                b();
    ...
    !function() {
        try {
            ...
            a.innerHTML = '<xyz></xyz>', p = 'hidden' in a,
    ...
    var z = /^$|\b(?:all|print)\b/, A = 'html5shiv', B = !q && function() {
        ...
        return !(
            'undefined' == typeof b.namespaces || 'undefined' == typeof b.parentWindow ||
            'undefined' == typeof c.applyElement || 'undefined' == typeof c.removeNode ||
