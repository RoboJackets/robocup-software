...
/**
 * @brief The Window class represents an open shot from a point to a target segment.
 */
class Window {
public:
  Window();
...
/**
 * @brief The WindowEvaluator class calculates open shots from a point to a target.
 */
...
public:
  ...
  /**
   * @brief Evaluates shot windows to a target point, using a virtual width for the target
