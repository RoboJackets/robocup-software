...
InternalReferee::InternalReferee()
        : RefereeBase("internal_referee") {
        ...
        [this] (QuickCommands::Request::SharedPtr request,
            ...
            switch (request->state) {
                ...
                case QuickCommands::Request::COMMAND_PLAY:
                    ...
                    break;
                default:
                    throw std::runtime_error("Unknown quick command " + std::to_string(request->state));
            }
            send();
        });
        ...
        [this] (QuickRestart::Request::SharedPtr request,
            ...
            switch (request->restart) {
                ...
                case QuickRestart::Request::RESTART_KICKOFF:
                    ...
                    break;
                default:
                    throw std::runtime_error("Unknown quick restart " + std::to_string(request->restart));
            }
            send();
        });
