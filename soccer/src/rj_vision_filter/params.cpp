...
DEFINE_NS_INT64(
    kVisionFilterParamModule, health, init, 2,
    "Initial health of the Kalman filters. Must be between min and max.")
DEFINE_NS_INT64(kVisionFilterParamModule, health, inc, 2,
                "How much to increment every measurement.")
DEFINE_NS_INT64(kVisionFilterParamModule, health, dec, 1,
                "How much to decrement every predict without measurement.")
DEFINE_NS_INT64(kVisionFilterParamModule, health, max, 20,
                "Max health of the filters.")
DEFINE_NS_INT64(kVisionFilterParamModule, health, min, 1,
                "Min health of the filters, must be greater than 0.")

DEFINE_NS_INT64(kVisionFilterParamModule, kick::detector, slow_hist_length, 5,
                "How many frames to store for the slow kick detector.")
DEFINE_NS_INT64(kVisionFilterParamModule, kick::detector, fast_hist_length, 3,
