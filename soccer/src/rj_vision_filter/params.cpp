...
DEFINE_NS_INT64(
    kVisionFilterParamModule, filter::health, init, 2,
...
DEFINE_NS_INT64(kVisionFilterParamModule, filter::health, max, 20,
...
DEFINE_NS_INT64(kVisionFilterParamModule, kick::detector, slow_kick_hist_length,
                5, "How many frames to store for the slow kick detector.")
DEFINE_NS_INT64(kVisionFilterParamModule, kick::detector, fast_kick_hist_length,
                3, "How many frames to store for the fast kick detector.")
}  // namespace vision_filter