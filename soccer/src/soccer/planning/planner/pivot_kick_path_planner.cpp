#include "planning/planner/pivot_kick_path_planner.hpp"
...
Trajectory PivotKickPathPlanner::initial(const PlanRequest& plan_request) {
    // Getting ball info
    const BallState& ball = plan_request.world_state->ball;
...
Trajectory PivotKickPathPlanner::final(const PlanRequest& plan_request) {
    const BallState& ball = plan_request.world_state->ball;
...
void PivotKickPathPlanner::process_state_transition() {
...
bool PivotKickPathPlanner::is_done() const {
