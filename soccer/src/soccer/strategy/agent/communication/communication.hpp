...
*/
using AgentRequest = std::variant<JoinWallRequest, LeaveWallRequest, PassRequest, BallInTransitRequest, ResetScorerRequest, PositionRequest, IncomingBallRequest, TestRequest, ScorerRequest>;

/**
* @brief a conglomeration of the different response types.
*/
using AgentResponseVariant = std::variant<Acknowledge, PositionResponse, TestResponse, ScorerResponse, LeaveWallResponse, PassResponse, JoinWallResponse>;
