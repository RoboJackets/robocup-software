...
#include "scorer_cancel_request.hpp"
 ...
 */
using AgentRequest = std::variant<BallInTransitRequest, ScorerRequest, TestRequest, PassRequest,
                                  IncomingBallRequest, ScorerCancelRequest, ResetScorerRequest,
                                  JoinWallRequest, LeaveWallRequest, PositionRequest>;

/**
 * @brief a conglomeration of the different response types.
 */
using AgentResponseVariant =
    std::variant<TestResponse, LeaveWallResponse, JoinWallResponse, PositionResponse, Acknowledge,
                 PassResponse, ScorerResponse>;
...
struct RosConverter<strategy::communication::AgentRequest, rj_msgs::msg::AgentRequest> {
    static rj_msgs::msg::AgentRequest to_ros(const strategy::communication::AgentRequest& from) {
        ...
        if (const auto* ball_in_transit_request =
        ...
        } else if (const auto* scorer_cancel_request =
                       std::get_if<strategy::communication::ScorerCancelRequest>(&from)) {
            result.scorer_cancel_request.emplace_back(convert_to_ros(*scorer_cancel_request));
    ...
    static strategy::communication::AgentRequest from_ros(const rj_msgs::msg::AgentRequest& from) {
        ...
        if (!from.ball_in_transit_request.empty()) {
        ...
        } else if (!from.scorer_cancel_request.empty()) {
            result = convert_from_ros(from.scorer_cancel_request.front());
...
struct RosConverter<strategy::communication::AgentResponse, rj_msgs::msg::AgentResponse> {
    ...
    static strategy::communication::AgentResponse from_ros(
        ...
        if (!from.response.test_response.empty()) {
