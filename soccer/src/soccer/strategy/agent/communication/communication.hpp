...
*/
using AgentRequest = std::variant<IncomingBallRequest, SeekerRequest, ScorerRequest, ResetScorerRequest, KickerRequest, JoinWallRequest, TestRequest, PassRequest, BallInTransitRequest, PositionRequest, LeaveWallRequest>;

/**
* @brief a conglomeration of the different response types.
*/
using AgentResponseVariant = std::variant<LeaveWallResponse, TestResponse, PositionResponse, PassResponse, ScorerResponse, Acknowledge, JoinWallResponse>;
