 ...
 */
using AgentRequest = std::variant<LeaveWallRequest, PassRequest, TestRequest, BallInTransitRequest,
                                  KickerRequest, JoinWallRequest, ScorerRequest,
                                  IncomingBallRequest, ResetScorerRequest, PositionRequest>;

/**
 * @brief a conglomeration of the different response types.
 */
using AgentResponseVariant =
    std::variant<LeaveWallResponse, ScorerResponse, JoinWallResponse, Acknowledge, PositionResponse,
                 PassResponse, TestResponse>;
...
struct RosConverter<strategy::communication::AgentRequest, rj_msgs::msg::AgentRequest> {
    static rj_msgs::msg::AgentRequest to_ros(const strategy::communication::AgentRequest& from) {
        ...
        if (const auto* leave_wall_request =
