...
*/
using AgentRequest = std::variant<LeaveWallRequest, PassRequest, SeekerRequest, TestRequest, BallInTransitRequest, JoinWallRequest, ScorerRequest, IncomingBallRequest, ResetScorerRequest, PositionRequest>;
