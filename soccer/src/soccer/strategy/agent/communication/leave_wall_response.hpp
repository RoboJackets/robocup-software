...
struct RosConverter<strategy::communication::LeaveWallResponse, rj_msgs::msg::LeaveWallResponse> {
	static rj_msgs::msg::LeaveWallResponse to_ros(const strategy::communication::LeaveWallResponse& from) {
	...
	static strategy::communication::LeaveWallResponse from_ros(const rj_msgs::msg::LeaveWallResponse& from) {
