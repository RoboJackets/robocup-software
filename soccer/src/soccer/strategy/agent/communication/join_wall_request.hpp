...
struct RosConverter<strategy::communication::JoinWallRequest, rj_msgs::msg::JoinWallRequest> {
	static rj_msgs::msg::JoinWallRequest to_ros(const strategy::communication::JoinWallRequest& from) {
	...
	static strategy::communication::JoinWallRequest from_ros(const rj_msgs::msg::JoinWallRequest& from) {
