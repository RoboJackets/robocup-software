 ...
 */
class OffenseRight : public Position {
public:
    OffenseRight(int r_id);
    ~OffenseRight() override = default;
    OffenseRight(const Position& other);
...
private:
    ...
    rj_geometry::Point seeker_point{-1.5, 6.5};
};
