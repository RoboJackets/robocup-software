#include "our_side_lineup.hpp"

namespace strategy {

OurSideLineup::OurSideLineup(int r_id) : Position(r_id) {
    position_name_ = "Line";
    r_id_ = r_id;
}

std::optional<RobotIntent> OurSideLineup::derived_get_task(RobotIntent intent) {
