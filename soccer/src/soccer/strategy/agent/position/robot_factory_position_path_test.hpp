 ...
 */
    class RobotFactoryPositionPathTest : public Position {
    public:
        RobotFactoryPositionPathTest(int r_id);
        ~RobotFactoryPositionPathTest() override = default;

        // Copy and move for this class is really annoying because it contains
        // a unique_ptr to an abstract class.
        RobotFactoryPositionPathTest(const RobotFactoryPositionPathTest& other) = delete;
        RobotFactoryPositionPathTest(RobotFactoryPositionPathTest&& other) = delete;
        RobotFactoryPositionPathTest& operator=(const RobotFactoryPositionPathTest& other) = delete;
        RobotFactoryPositionPathTest& operator=(RobotFactoryPositionPathTest&& other) = delete;
