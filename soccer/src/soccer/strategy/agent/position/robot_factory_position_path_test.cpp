...
namespace strategy {
    ...
    RobotFactoryPositionPathTest::RobotFactoryPositionPathTest(int r_id) : Position(r_id,"RobotFactoryPositionPathTest") {
        if (robot_id_ == 0) {
    ...
    std::optional<RobotIntent> RobotFactoryPositionPathTest::get_task(WorldState& world_state,
