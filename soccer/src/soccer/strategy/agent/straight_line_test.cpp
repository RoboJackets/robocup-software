...
StraightLineTest::StraightLineTest(int r_id)
    ...
    field_dimensions_sub_ = create_subscription<rj_msgs::msg::FieldDimensions>(
        ...
        [this](const rj_msgs::msg::FieldDimensions::SharedPtr msg) { field_dimensions_callback(msg); }
    );
    ...
    int hz = 10;
    get_task_timer_ = create_wall_timer(std::chrono::milliseconds(1000 / hz), std::bind(&StraightLineTest::get_task, this));
}
...
void StraightLineTest::field_dimensions_callback(const rj_msgs::msg::FieldDimensions::SharedPtr& msg) {
