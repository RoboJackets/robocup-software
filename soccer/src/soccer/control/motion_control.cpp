...
DEFINE_FLOAT64(params::kMotionControlParamModule, rotation_ki, 0.1,
...
DEFINE_FLOAT64(params::kMotionControlParamModule, translation_ki, 2.0,
               "Ki for translation ((m/s)/(m*s))");
DEFINE_FLOAT64(params::kMotionControlParamModule, translation_kd, 1.0,
               "Kd for translation ((m/s)/(m/s))");
DEFINE_INT64(params::kMotionControlParamModule, translation_windup, 20,
