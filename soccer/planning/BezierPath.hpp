...
namespace Planning
{
	...
	class BezierPath: public Path
	{
		public:
			...
			BezierPath(const Geometry2d::Point& p0);

			/** constructor from two points */
			BezierPath(const Geometry2d::Point& p0, const Geometry2d::Point& p1);
			...
			void startFrom(const Geometry2d::Point& pt, Planning::BezierPath& result) const;
