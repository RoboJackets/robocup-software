...
public:
  ...
  std::unique_ptr<Path> run(MotionInstant start,
...
protected:
  ...
  Geometry2d::Point
  findNonBlockedGoal(Geometry2d::Point goal,
  ...
  Planning::InterpolatedPath *runRRT(MotionInstant start, MotionInstant goal,
                                     const MotionConstraints &motionConstraints,
                                     const Geometry2d::ShapeSet *obstacles);
  ...
  optimize(Planning::InterpolatedPath &path,
           const Geometry2d::ShapeSet *obstacles,
   ...
   */
  Planning::InterpolatedPath *
  cubicBezier(Planning::InterpolatedPath &path,
              const Geometry2d::ShapeSet *obstacles,
              const MotionConstraints &motionConstraints, Geometry2d::Point vi,
              Geometry2d::Point vf);
