...
// All examples with zero-velocity endpoints are broken because of numerical issues (in this case, the second and third control points go on top of the first and fourth, respectively).
