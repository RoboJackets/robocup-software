...
class Mark(single_robot_behavior.SingleRobotBehavior):
	...
	def execute_running(self):
		...
		main.state().draw_line(ball_mark_line, QtGui.QColor(0,0,255), QtCore.QString("Mark"))
		...
		# TODO draw circle
		main.state().draw_circle(self._mark_robot.pos, constants.Robot.Radius * 1.2, QtGui.QColor(0, 127, 255), QtCore.QString("Mark"))
