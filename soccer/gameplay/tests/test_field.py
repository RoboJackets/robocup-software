...
class TestField(unittest.TestCase):
    ...
    def setUp(self):
        self.robots = [
            Moc_Robot(0, 0), Moc_Robot(0, 0), Moc_Robot(0, 0), Moc_Robot(0, 0),
            Moc_Robot(0, 0), Moc_Robot(0, 0)
        ]
    ...
    def test_space_coeff_at_pos(self):
        ...
        self.assertAlmostEqual(
            run_function(width * -1 / 2, 0),
            0,
            msg="Postion devoid of robots is not considered open")
        ...
        self.assertGreater(
            ...
            0,
            msg="Robots located around position considered to be open. Check constant inside function"
        )
    ...
    def test_field_pos_coeff_at_pos(self):
        ...
        self.assertAlmostEqual(
            num,
            1,
            msg="center of the field doesn't return 1 for distance to center factor"
        )
        ...
        self.assertAlmostEqual(
            num,
            0,
            msg="edge of the field doesn't return 0 for distance to center factor"
        )
        ...
        self.assertAlmostEqual(
            num,
            1,
            msg="position close to goal returns not 1 for distance to goal factor"
        )
        ...
        self.assertAlmostEqual(
            num,
            0,
            msg="other side of field doesn't return 0 for distance to goalfactor"
        )
