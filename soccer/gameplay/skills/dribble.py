...
class Dribble(single_robot_composite_behavior.SingleRobotCompositeBehavior):
    ...
    def __init__(self, pos=None):
        ...
        self.add_transition(Dribble.State.setup, Dribble.State.capture, lambda: self.subbehavior_with_name('move').state == behavior.Behavior.State.completed, 'moved to behind the ball' )
