...
#use line kicks always
class Basic123(standard_play.StandardPlay):
    ...
    def __init__(self):
        ...
        striker = skills.line_kick.LineKick()
    ...
    def execute_running(self):
        ...
        striker_engaged = striker.robot != None and closest_dist_to_striker < Basic123.SupportBackoffThresh
            ...
            if striker.robot != None:
                ...
                if ball_proj.y > constants.Field.Length / 2.0 and nrOppClose > 0:
                    support_goal.y = max(support_goal.y *
                                         Basic123.OffenseSupportRatio, 0.3)
                else:
                    support_goal.y = max(support_goal.y *
                                         Basic123.DefenseSupportRatio, 0.3)
        ...
        for i in range(2):
            ...
            if new_bots[i] != None:
                ...
                if (new_dists[i] < cur_dist_sq * Basic123.MarkHysteresisCoeff or
                    clear_all_marks):
        ...
        if ball_proj.y > constants.Field.Length / 2.0 and nrOppClose > 0:
            for support in supports:
                support.ratio = Basic123.OffenseSupportRatio
        else:
            for support in supports:
                support.ratio = Basic123.DefenseSupportRatio
