...
class Distraction(standard_play.StandardPlay):
    ...
    def __init__(self):
        ...
        self.distract_box = robocup.Rect(
            ...
            robocup.Point(constants.Field.Width, 
        ...
        self.distracter_get_close_ball = self.distract_box.contains_point(main.ball().pos)
        self.striker_get_close_ball = self.striker_box.contains_point(main.ball().pos)
