...
class SingleRobotSequence(behavior_sequence.BehaviorSequence,
    ...
    def __init__(self, behaviors=[], continuous=False):
        single_robot_composite_behavior.SingleRobotCompositeBehavior.__init__(self, continuous)
        behavior_sequence.BehaviorSequence.__init__(self, continuous=continuous, behaviors=behaviors)
