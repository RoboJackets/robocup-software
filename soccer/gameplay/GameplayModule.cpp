	...
	_mutex(QMutex::Recursive)
{
	...
	_centerMatrix = Geometry2d::TransformMatrix::translate(Geometry2d::Point(0, Field_Dimensions.Field_Length / 2));
	_oppMatrix = Geometry2d::TransformMatrix::translate(Geometry2d::Point(0, Field_Dimensions.Field_Length)) *
	...
	float x = Field_Dimensions.Field_Width / 2 + Field_Dimensions.Field_Border;
	const float y1 = Field_Dimensions.Field_Length / 2;
	const float y2 = Field_Dimensions.Field_Length + Field_Dimensions.Field_Border;
	const float r = Field_Dimensions.Field_CenterRadius;
	...
	float y = -Field_Dimensions.Field_Border;
	float deadspace = Field_Dimensions.Field_Border;
	x = Field_Dimensions.Floor_Width/2.0f;
	...
	y = Field_Dimensions.Field_Length + Field_Dimensions.Field_Border;
	...
	y = Field_Dimensions.Floor_Length;
	floorObstacle = new Polygon;
	...
	const float halfFlat = Field_Dimensions.Field_GoalFlat/2.0;
	const float radius = Field_Dimensions.Field_ArcRadius;
	...
	_ourHalf->vertices.push_back(Geometry2d::Point(-x, -Field_Dimensions.Field_Border));
...
void Gameplay::GameplayModule::run()
{
	...
	{
		_state->drawCircle(_state->ball.pos, Field_Dimensions.Field_CenterRadius, Qt::black, "Rules");
	}
