...
TEST(Camera, update_with_single_frame) {
    ...
    b.emplace_back(RJ::now(), rj_geometry::Point(0, 0));
    b.emplace_back(RJ::now(), rj_geometry::Point(0.5, 0.5));

    yr.at(0).emplace_back(RJ::now(), rj_geometry::Pose(rj_geometry::Point(1, 1), 0), 0);
    yr.at(0).emplace_back(RJ::now(), rj_geometry::Pose(rj_geometry::Point(1.5, 1.5), 0.5), 0);
