...
class RobotState:
    ...
    def __init__(
        self, robot_id: RobotId, pose: np.ndarray, twist: np.ndarray, visible: bool
    ):
        self.id = robot_id
        self.pose = pose
        self.twist = twist
...
class PartialWorldState:
    ...
    def __init__(
        self, our_robots: List[rc.Robot], their_robots: List[rc.Robot], ball: rc.Ball
    ):
...
def build_game_info(
    ...
    game_info = rc.GameInfo(
        ...
        restart,
        our_restart,
        np.array([play_state_msg.placement_point.x, play_state_msg.placement_point.y]),
    )
...
def worldstate_creator(
    ...
    world_state = rc.WorldState(
        our_robots, their_robots, partial_world_state.ball, game_info, field, goalie_id
    )
