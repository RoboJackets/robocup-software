...
class RestartPlay(play.IPlay):
    ...
    def __init__(self, action_client_dict: Dict[Type[Any], List[Any]]):
        ...
        self.clear_tactic = clear_tactic.Clear(
            action_client_dict, np.array([0.0, 9.0]), chip=True, kick_speed=3.0
        )
        # TODO: make it pass
        """
        ...
        self.wall_tactic_1 = wall_tactic.WallTactic(
            action_client_dict, role.Priority.LOW, cost_scale=0.1
        )
...
class DirectRestartPlay(play.IPlay):
    ...
    def __init__(self, action_client_dict: Dict[Type[Any], List[Any]]):
        ...
        self.goalie_tactic = goalie_tactic.GoalieTactic(action_client_dict)
        self.clear_tactic = clear_tactic.Clear(
            action_client_dict, np.array([0.0, 9.0]), chip=False, kick_speed=5.5
        )
        # TODO: make it pass
        """
        self.pass_tactic = pass_tactic.Pass(
