...
class RunnerTactic(stp.tactic.Tactic):
    """Wrapper for the Runner Role that handles assigning said role to whichever Robot is our runner."""

    def __init__(self, world_state: stp.rc.WorldState, runner_id: int):
        """Special case where we want only robot 0 to be runner, from init."""
        super().__init__(world_state)

        # TODO: rather than passing in hardcoded runner id on init, gameplay node should
