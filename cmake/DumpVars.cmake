...
message( STATUS "MBED_TARGET_SERIES:\t\t\t"             "${MBED_TARGET_SERIES}"                 )
message( STATUS "MBED_TARGET_ISA:\t\t\t"                "${MBED_TARGET_ISA}"                    )
message( STATUS "MBED_TARGET_ARCH:\t\t\t"               "${MBED_TARGET_ARCH}"                   )
message( STATUS "MBED_TARGET_LABELS_EXTRA:\t\t"         "${MBED_TARGET_LABELS_EXTRA}"           )
message( STATUS "MBED_TARGET_RTOS_ARCHS:\t\t"           "${MBED_TARGET_RTOS_ARCHS}"             )
message( STATUS "ARM C_COMPILER:\t\t\t"                 "${ARM_C_COMPILER}"                     )
message( STATUS "ARM_CXX_COMPILER:\t\t\t"               "${ARM_CXX_COMPILER}"                   )
message( STATUS "AVR C_COMPILER:\t\t\t"                 "${AVR_C_COMPILER}"                     )
...
message( STATUS "MBED_INCLUDE_DIR:"                                                             )
foreach( i ${MBED_INCLUDE_DIR} )
    get_filename_component( fn ${i} DIRECTORY )
    message( STATUS "\t\t\t\t\t${fn}" )
endforeach()
