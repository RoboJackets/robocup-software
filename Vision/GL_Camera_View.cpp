...
Geometry2d::Point GL_Camera_View::frame_position(QPoint pt)
{
...
{
	Geometry2d::Point pos = frame_position(e->pos());
...
void GL_Camera_View::wheelEvent(QWheelEvent *e)
{
    ...
    Geometry2d::Point delta = frame_position(e->pos()) - pos;
    offset_x -= delta.x;
    offset_y -= delta.y;
...
void GL_Camera_View::mouse_edit_color(Geometry2d::Point &pos, Qt::MouseButtons buttons)
{
    if (edit_color >= 0)
    {
