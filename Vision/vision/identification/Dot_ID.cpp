...
void Vision::Dot_ID::set_report(Group *center_group, const Pattern &pattern, const Geometry2d::Point &center, const Geometry2d::Point &facing)
{
	...
	r.x = center.x;
	r.y = center.y;
	r.angle = facing.angle() * 180.0f/M_PI;
	
	_robots.push_back(r);
}

void Vision::Dot_ID::set_report(Group *center_group, const Pattern &pattern, int id, const Geometry2d::Point &center, const Geometry2d::Point &facing)
{
    center_group->id = id;
