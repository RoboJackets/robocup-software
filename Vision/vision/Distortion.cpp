...
Geometry2d::Point Vision::Distortion::undistort(Geometry2d::Point pt) const
{
	QMutexLocker ml(&mutex);
	
	Geometry2d::Point pp, out;
...
void Vision::Distortion::auto_calibrate()
{
    if (cal_lines.empty())
    {
        printf("Distortion::auto_calibrate(): No calibration lines\n");
        return;
    }
...
float Vision::Distortion::auto_cal_error()
{
	...
	{
		Geometry2d::Segment seg(undistort(line->points.front()),
