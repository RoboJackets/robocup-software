...
: ${AMENT_CURRENT_PREFIX:="/root/robocup-software/install/rj_convert"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rj_convert/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rj_convert/environment/path.sh"
