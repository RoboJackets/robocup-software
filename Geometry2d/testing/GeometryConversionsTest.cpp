...
TEST(ROSConvertGeometry, pose_convert) {
    test_lossless_convert_ros_value(rj_geometry_msgs::build<rj_geometry_msgs::msg::Pose>()
                                        ...
                                        .heading(3.0));
    test_lossless_convert_cpp_value(Geometry2d::Pose{1, 2, 3});
}
...
TEST(ROSConvertGeometry, twist_convert) {
    test_lossless_convert_ros_value(rj_geometry_msgs::build<rj_geometry_msgs::msg::Twist>()
                                        ...
                                        .angular(3.0));
    test_lossless_convert_cpp_value(Geometry2d::Twist{1, 2, 3});
}
...
TEST(ROSConvertGeometry, line_convert) {
    ...
    test_lossless_convert_cpp_value(Geometry2d::Line(make_rj_point(), make_rj_point() * 2));
}
...
TEST(ROSConvertGeometry, segment_convert) {
    ...
    test_lossless_convert_cpp_value(Geometry2d::Segment(make_rj_point(), make_rj_point() * 2));
}
...
TEST(ROSConvertGeometry, rect_convert) {
    ...
    test_lossless_convert_cpp_value(Geometry2d::Rect(make_rj_point(), make_rj_point() * 2));
}
