...
public:
    ...
    void draw_polygon(const rj_geometry::Point*, int, const QColor& = Qt::black,
                      const QString& = QString()) {}

    /** @ingroup drawing_functions */
    void draw_polygon(const std::vector<rj_geometry::Point>&, const QColor& = Qt::black,
                      const QString& = QString()) {}

    /** @ingroup drawing_functions */
    void draw_polygon(const rj_geometry::Polygon&, const QColor& = Qt::black,
                      const QString& = QString()) {}

    /** @ingroup drawing_functions */
    void draw_circle(rj_geometry::Point, float, const QColor& = Qt::black,
                     const QString& = QString()) {}

    /** @ingroup drawing_functions */
    void draw_arc(const rj_geometry::Arc&, const QColor& = Qt::black, const QString& = QString()) {}

    /** @ingroup drawing_functions */
    void draw_shape(const std::shared_ptr<rj_geometry::Shape>&, const QColor& = Qt::black,
                    const QString& = QString()) {}

    /** @ingroup drawing_functions */
    void draw_shape_set(const rj_geometry::ShapeSet&, const QColor& = Qt::black,
                        const QString& = QString()) {}
    ...
    /** @ingroup drawing_functions */
    void draw_line(rj_geometry::Point, rj_geometry::Point, const QColor& = Qt::black,
                   const QString& = QString()) {}

    /** @ingroup drawing_functions */
    void draw_text(const QString&, rj_geometry::Point, const QColor& = Qt::black,
                   const QString& = QString()) {}
