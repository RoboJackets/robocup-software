...
GameSettingsMsg parse_game_settings(const std::vector<std::string>& args) {
    ...
    // The config server publishes use_our_half and use_their_half as false, because parse_game_settings never sets them.
    // Forcing them to true here fixes the grey-field issue.
