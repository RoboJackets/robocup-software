...
template <typename RosType, typename CppType = typename rj_convert::AssociatedCppType<RosType>::T>
...
template <typename CppType, typename RosType = typename rj_convert::AssociatedRosType<CppType>::T>
