...
Rotate::Rotate(Position&& other) : Position{std::move(other)} { position_name_ = "Rotate"; }

Rotate::Rotate(int r_id) : Position{r_id, "Rotate"} {}

Rotate::Rotate(int r_id, bool vertical) : Position{r_id, "Rotate"}, vertical_{vertical} {}
