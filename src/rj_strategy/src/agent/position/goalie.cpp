...
Goalie::Goalie(int r_id, std::shared_ptr<ClientHandles> clientHandles)
    : Position(r_id, "Goalie"), clientHandles_{clientHandles} {}

Goalie::Goalie(const Position& other, std::shared_ptr<ClientHandles> clientHandles)
