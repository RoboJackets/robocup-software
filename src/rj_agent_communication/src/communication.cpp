#include "rj_agent_communication/communication.hpp"

namespace communication {

std::mutex request_uid_mutex;//NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
u_int32_t request_uid = 0;//NOLINT(cppcoreguidelines-avoid-non-const-global-variables)

std::mutex response_uid_mutex;//NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
u_int32_t response_uid = 0;//NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
