...
void Distortion_Setup::mousePressEvent(QMouseEvent *e, Geometry::Point2d pos)
{
...
void Distortion_Setup::mouseMoveEvent(QMouseEvent *e, Geometry::Point2d pos)
{
...
void Distortion_Setup::mouseDoubleClickEvent(QMouseEvent *e, Geometry::Point2d pos)
{
	if (e->button() == Qt::LeftButton)
	{
...
void Distortion_Setup::draw_cal_line(Vision::Calibration_Line *line)
{
	...
	BOOST_FOREACH(const Geometry::Point2d &pt, line->points)
	{
