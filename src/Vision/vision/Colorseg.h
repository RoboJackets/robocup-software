...
namespace Vision
{
    ...
    public:
        ...
        const QImage &output() const { return _output; }
    ...
    protected:
        ...
        static const uint32_t red_mask = ((1 << red_bits) - 1) << (8 - red_bits + 16);
        static const uint32_t green_mask = ((1 << green_bits) - 1) << (8 - green_bits + 8);
        static const uint32_t blue_mask = ((1 << blue_bits) - 1) << (8 - blue_bits);
