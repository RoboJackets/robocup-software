...
namespace Vision
{
    ...
    public:
        ...
        Pattern(float a, const Geometry::Point2d &c, const std::vector<Color_Sequence> &s):
            angle_offset(a), center_offset(c), sequences(s)
        {
        }
        
        float angle_offset;
        Geometry::Point2d center_offset;
    ...
    public:
        ...
        void set_report(Group *center, const Pattern &pattern, const Geometry::Point2d &center, const Geometry::Point2d &facing);
        void set_report(Group *center, const Pattern &pattern, int id, const Geometry::Point2d &center, const Geometry::Point2d &facing);
        
        const std::vector<Dot> &dots() const { return _dots; }
        const Geometry::Point2d &center() const { return _center; }
