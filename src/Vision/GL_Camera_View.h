#ifndef _GL_CAMERA_VIEW_H_
#define _GL_CAMERA_VIEW_H_
...
public:
    ...
    Geometry::Point2d last_mouse_pos() const { return _last_mouse_pos; }
...
protected:
    ...
    Geometry::Point2d _last_mouse_pos;
    
    void full_rect();
    void draw_spanner(const Vision::Spanner *spanner);
    void draw_tracker(const Vision::Tracker *tracker);
    
    // Converts view coordinates to frame coordinates
    Geometry::Point2d frame_position(QPoint pt);
    
    void mouse_edit_color(Geometry::Point2d &pos, Qt::MouseButtons buttons);
