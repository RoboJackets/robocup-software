...
#include "param.hpp"
#include "ros2_global_param_provider.hpp"
...
DECLARE_NS_FLOAT64(kGlobalParamModule, soccer::robot, max_dribbler_speed)
...
DECLARE_NS_FLOAT64(kGlobalParamModule, soccer::robot, chip_angle)
