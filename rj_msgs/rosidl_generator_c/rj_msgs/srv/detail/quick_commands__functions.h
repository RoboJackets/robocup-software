...
#ifndef RJ_MSGS__SRV__DETAIL__QUICK_COMMANDS__FUNCTIONS_H_
#define RJ_MSGS__SRV__DETAIL__QUICK_COMMANDS__FUNCTIONS_H_
...
/// Initialize srv/QuickCommands message.
/**
...
/// Finalize srv/QuickCommands message.
/**
...
/// Create srv/QuickCommands message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rj_msgs__srv__QuickCommands_Request__init().
...
/// Destroy srv/QuickCommands message.
/**
 * It calls
 * rj_msgs__srv__QuickCommands_Request__fini()
...
/// Initialize array of srv/QuickCommands messages.
/**
...
/// Finalize array of srv/QuickCommands messages.
/**
 * It calls
 * rj_msgs__srv__QuickCommands_Request__fini()
...
/// Create array of srv/QuickCommands messages.
/**
 * It allocates the memory for the array and calls
 * rj_msgs__srv__QuickCommands_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/QuickCommands messages.
/**
 * It calls
 * rj_msgs__srv__QuickCommands_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rj_msgs__srv__QuickCommands_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rj_msgs
...
/**
 * It calls
 * rj_msgs__srv__QuickCommands_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rj_msgs
...
/**
 * It allocates the memory for the array and calls
 * rj_msgs__srv__QuickCommands_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rj_msgs
...
/**
 * It calls
 * rj_msgs__srv__QuickCommands_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // RJ_MSGS__SRV__DETAIL__QUICK_COMMANDS__FUNCTIONS_H_
