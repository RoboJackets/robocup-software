...
bool rj_msgs__msg__intercept_motion_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rj_msgs.msg._intercept_motion_command.InterceptMotionCommand", full_classname_dest, 60) == 0);
  }
  rj_msgs__msg__InterceptMotionCommand * ros_message = _ros_message;
  {  // target
...
{
  /* NOTE(esteve): Call constructor of InterceptMotionCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rj_msgs.msg._intercept_motion_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "InterceptMotionCommand");
