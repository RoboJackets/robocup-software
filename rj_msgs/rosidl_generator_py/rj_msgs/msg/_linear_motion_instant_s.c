...
bool rj_msgs__msg__linear_motion_instant__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rj_msgs.msg._linear_motion_instant.LinearMotionInstant", full_classname_dest, 54) == 0);
  }
  rj_msgs__msg__LinearMotionInstant * ros_message = _ros_message;
  {  // position
...
{
  /* NOTE(esteve): Call constructor of LinearMotionInstant */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rj_msgs.msg._linear_motion_instant");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LinearMotionInstant");
