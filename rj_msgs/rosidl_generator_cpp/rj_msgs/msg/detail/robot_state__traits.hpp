...
#ifndef RJ_MSGS__MSG__DETAIL__ROBOT_STATE__TRAITS_HPP_
#define RJ_MSGS__MSG__DETAIL__ROBOT_STATE__TRAITS_HPP_
...
template<>
inline const char * data_type<rj_msgs::msg::RobotState>()
{
  return "rj_msgs::msg::RobotState";
}

template<>
inline const char * name<rj_msgs::msg::RobotState>()
{
  return "rj_msgs/msg/RobotState";
}

template<>
struct has_fixed_size<rj_msgs::msg::RobotState>
...
template<>
struct has_bounded_size<rj_msgs::msg::RobotState>
...
template<>
struct is_message<rj_msgs::msg::RobotState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // RJ_MSGS__MSG__DETAIL__ROBOT_STATE__TRAITS_HPP_
