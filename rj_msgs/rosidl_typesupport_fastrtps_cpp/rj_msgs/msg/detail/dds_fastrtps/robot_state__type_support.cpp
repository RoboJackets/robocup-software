...
#include "rj_msgs/msg/detail/robot_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rj_msgs::msg::RobotState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rj_msgs::msg::RobotState & ros_message)
{
  // Member: stamp
...
{
  auto typed_message =
    static_cast<const rj_msgs::msg::RobotState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rj_msgs::msg::RobotState *>(
    untyped_ros_message);
...
{
  return &rj_msgs::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rj_msgs, msg, RobotState)() {
  return &rj_msgs::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
