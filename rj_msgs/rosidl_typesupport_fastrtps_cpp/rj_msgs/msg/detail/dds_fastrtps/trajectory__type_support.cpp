...
#include "rj_msgs/msg/detail/trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const rj_msgs::msg::RobotInstant &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  rj_msgs::msg::Trajectory & ros_message)
{
  ...
  // Member: instants
  {
    ...
    ros_message.instants.resize(size);
    for (size_t i = 0; i < size; i++) {
      rj_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.instants[i]);
    }
  }
  ...
  // Member: instants
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.instants[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: instants
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        rj_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_RobotInstant(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const rj_msgs::msg::Trajectory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rj_msgs::msg::Trajectory *>(
    untyped_ros_message);
...
{
  return &rj_msgs::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
