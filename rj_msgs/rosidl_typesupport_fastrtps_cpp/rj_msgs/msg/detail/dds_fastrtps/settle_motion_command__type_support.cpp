...
#include "rj_msgs/msg/detail/settle_motion_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rj_msgs::msg::SettleMotionCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rj_msgs::msg::SettleMotionCommand & ros_message)
{
  // Member: maybe_target
  {
    uint32_t cdrSize;
    ...
    ros_message.maybe_target.resize(size);
    for (size_t i = 0; i < size; i++) {
      rj_geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.maybe_target[i]);
    }
  }
  ...
  // Member: maybe_target
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.maybe_target[index], current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const rj_msgs::msg::SettleMotionCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rj_msgs::msg::SettleMotionCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SettleMotionCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rj_msgs::msg::SettleMotionCommand *>(
...
{
  return max_serialized_size_SettleMotionCommand(full_bounded, 0);
}

static message_type_support_callbacks_t _SettleMotionCommand__callbacks = {
  "rj_msgs::msg",
  "SettleMotionCommand",
...
static rosidl_message_type_support_t _SettleMotionCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SettleMotionCommand__callbacks,
...
{
  return &rj_msgs::msg::typesupport_fastrtps_cpp::_SettleMotionCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rj_msgs, msg, SettleMotionCommand)() {
  return &rj_msgs::msg::typesupport_fastrtps_cpp::_SettleMotionCommand__handle;
}
