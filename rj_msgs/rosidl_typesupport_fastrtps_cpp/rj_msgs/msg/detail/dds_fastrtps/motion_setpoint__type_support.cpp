...
#include "rj_msgs/msg/detail/motion_setpoint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rj_msgs::msg::MotionSetpoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rj_msgs::msg::MotionSetpoint & ros_message)
{
  // Member: velocity_x_mps
  cdr >> ros_message.velocity_x_mps;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rj_msgs
max_serialized_size_MotionSetpoint(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const rj_msgs::msg::MotionSetpoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rj_msgs::msg::MotionSetpoint *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MotionSetpoint__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rj_msgs::msg::MotionSetpoint *>(
...
{
  return max_serialized_size_MotionSetpoint(full_bounded, 0);
}

static message_type_support_callbacks_t _MotionSetpoint__callbacks = {
  "rj_msgs::msg",
  "MotionSetpoint",
...
static rosidl_message_type_support_t _MotionSetpoint__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MotionSetpoint__callbacks,
...
{
  return &rj_msgs::msg::typesupport_fastrtps_cpp::_MotionSetpoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rj_msgs, msg, MotionSetpoint)() {
  return &rj_msgs::msg::typesupport_fastrtps_cpp::_MotionSetpoint__handle;
}
