...
#include "rj_msgs/msg/detail/world_vel_motion_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rj_msgs::msg::WorldVelMotionCommand & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: world_vel
  rj_geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.world_vel,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rj_msgs::msg::WorldVelMotionCommand & ros_message)
{
  // Member: world_vel
...
{
  auto typed_message =
    static_cast<const rj_msgs::msg::WorldVelMotionCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rj_msgs::msg::WorldVelMotionCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _WorldVelMotionCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rj_msgs::msg::WorldVelMotionCommand *>(
...
{
  return max_serialized_size_WorldVelMotionCommand(full_bounded, 0);
}

static message_type_support_callbacks_t _WorldVelMotionCommand__callbacks = {
  "rj_msgs::msg",
...
static rosidl_message_type_support_t _WorldVelMotionCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_WorldVelMotionCommand__callbacks,
...
{
  return &rj_msgs::msg::typesupport_fastrtps_cpp::_WorldVelMotionCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rj_msgs, msg, WorldVelMotionCommand)() {
  return &rj_msgs::msg::typesupport_fastrtps_cpp::_WorldVelMotionCommand__handle;
}
