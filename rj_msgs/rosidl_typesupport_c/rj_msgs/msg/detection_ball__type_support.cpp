...
static const _DetectionBall_type_support_symbol_names_t _DetectionBall_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rj_msgs, msg, DetectionBall)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rj_msgs, msg, DetectionBall)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rj_msgs, msg, DetectionBall)() {
  return &::rj_msgs::msg::rosidl_typesupport_c::DetectionBall_message_type_support_handle;
}
