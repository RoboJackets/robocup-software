...
static const _QuickRestart_Request_type_support_symbol_names_t _QuickRestart_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rj_msgs, srv, QuickRestart_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rj_msgs, srv, QuickRestart_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rj_msgs, srv, QuickRestart_Request)() {
  return &::rj_msgs::srv::rosidl_typesupport_c::QuickRestart_Request_message_type_support_handle;
}
...
static const _QuickRestart_Response_type_support_symbol_names_t _QuickRestart_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rj_msgs, srv, QuickRestart_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rj_msgs, srv, QuickRestart_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_rj_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rj_msgs, srv, QuickRestart_Response)() {
  return &::rj_msgs::srv::rosidl_typesupport_c::QuickRestart_Response_message_type_support_handle;
}
...
static const _QuickRestart_type_support_symbol_names_t _QuickRestart_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rj_msgs, srv, QuickRestart)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rj_msgs, srv, QuickRestart)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rj_msgs, srv, QuickRestart)() {
  return &::rj_msgs::srv::rosidl_typesupport_c::QuickRestart_service_type_support_handle;
}
