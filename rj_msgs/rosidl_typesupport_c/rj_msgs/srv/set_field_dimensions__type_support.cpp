...
static const _SetFieldDimensions_Request_type_support_symbol_names_t _SetFieldDimensions_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rj_msgs, srv, SetFieldDimensions_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rj_msgs, srv, SetFieldDimensions_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rj_msgs, srv, SetFieldDimensions_Request)() {
  return &::rj_msgs::srv::rosidl_typesupport_c::SetFieldDimensions_Request_message_type_support_handle;
}
...
static const _SetFieldDimensions_Response_type_support_symbol_names_t _SetFieldDimensions_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rj_msgs, srv, SetFieldDimensions_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rj_msgs, srv, SetFieldDimensions_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_rj_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rj_msgs, srv, SetFieldDimensions_Response)() {
  return &::rj_msgs::srv::rosidl_typesupport_c::SetFieldDimensions_Response_message_type_support_handle;
}
...
static const _SetFieldDimensions_type_support_symbol_names_t _SetFieldDimensions_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rj_msgs, srv, SetFieldDimensions)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rj_msgs, srv, SetFieldDimensions)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rj_msgs, srv, SetFieldDimensions)() {
  return &::rj_msgs::srv::rosidl_typesupport_c::SetFieldDimensions_service_type_support_handle;
}
