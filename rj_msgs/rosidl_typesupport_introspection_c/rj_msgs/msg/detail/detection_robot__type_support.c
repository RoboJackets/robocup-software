  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  rj_msgs__msg__DetectionRobot__init(message_memory);
}

void DetectionRobot__rosidl_typesupport_introspection_c__DetectionRobot_fini_function(void * message_memory)
{
  rj_msgs__msg__DetectionRobot__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember DetectionRobot__rosidl_typesupport_introspection_c__DetectionRobot_message_member_array[8] = {
  {
    "confidence",  // name
    ...
    offsetof(rj_msgs__msg__DetectionRobot, confidence),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rj_msgs__msg__DetectionRobot, robot_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rj_msgs__msg__DetectionRobot, x),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rj_msgs__msg__DetectionRobot, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rj_msgs__msg__DetectionRobot, orientation),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rj_msgs__msg__DetectionRobot, pixel_x),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rj_msgs__msg__DetectionRobot, pixel_y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rj_msgs__msg__DetectionRobot, height),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers DetectionRobot__rosidl_typesupport_introspection_c__DetectionRobot_message_members = {
  ...
  8,  // number of fields
  sizeof(rj_msgs__msg__DetectionRobot),
