...
#include "rj_msgs/msg/detail/robot_instant__rosidl_typesupport_fastrtps_c.h"
...
using _RobotInstant__ros_msg_type = rj_msgs__msg__RobotInstant;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RobotInstant__ros_msg_type * ros_message = static_cast<const _RobotInstant__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
  ...
  void * untyped_ros_message)
{
  ...
  _RobotInstant__ros_msg_type * ros_message = static_cast<_RobotInstant__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _RobotInstant__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rj_msgs__msg__RobotInstant(
...
{
  return max_serialized_size_rj_msgs__msg__RobotInstant(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_RobotInstant = {
  "rj_msgs::msg",
  "RobotInstant",
...
static rosidl_message_type_support_t _RobotInstant__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RobotInstant,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rj_msgs, msg, RobotInstant)() {
  return &_RobotInstant__type_support;
}
